...
MODEL_NAME = "mnist_model" # Model file prefix
...
def backward():
    ...
    image_batch, label_batch = mnist_generate_dataset.get_tfRecord(BATCH_SIZE, getTrain=True) # Get training batch
