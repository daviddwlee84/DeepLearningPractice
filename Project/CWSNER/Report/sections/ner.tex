...
\fnurl{Named entity recognition}{https://en.wikipedia.org/wiki/Named-entity_recognition} task is very similar with word segmentation. We can also reduce it into a sequence labeling or a classification problem.
