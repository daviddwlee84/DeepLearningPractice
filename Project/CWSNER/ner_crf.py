...
if __name__ == "__main__":
    ...
    if FUNC.Train_Test_Eval_train or FUNC.Train_Test_Eval_predict:
        ...
        if FUNC.Train_Test_Eval_predict:
            test30percent = combine_ner_numpy_pred_to_evaluable_format(
                test_data_list, test_predict, NER_LabelEncode, test_predict_filename)
    ...
    if FUNC.Final_Submit_train or FUNC.Final_Submit_predict:
        ...
        if FUNC.Final_Submit_predict:
            combine_ner_numpy_pred_to_evaluable_format(
                final_raw_list, final_predict, NER_LabelEncode, SUBMISSION.NER)
